...
public class TestCases {
	...
	public void queSePuedaArmarElConvoy() {
		...
		assertEquals(12, argentina.getCapacidadDeDefensa(), 0);
	}
	...
	public void queSePuedaCrearUnaBatalla() {
		...
		assertEquals(100.5, argentina.getBatalla("San Lorenzo").getLatitud(), 0);
		assertEquals(20.3, argentina.getBatalla("San Lorenzo").getLongitud(), 0);
	...
	public void queSePuedaPresentarBatallaNaval() throws VehiculoInexistente, VehiculoIncompatible {
		...
		assertEquals(6, argentina.getCapacidadDeDefensa(), 0);
